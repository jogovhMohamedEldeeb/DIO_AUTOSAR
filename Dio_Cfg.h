 ...
 * @File 		Dio_Cfg.h                                            
 * @Version 	1.0.0                                                                                                   
 * @brief   	AUTOSAR Dio configuration level header
 * @details 	Pre-Compile Configuration Header file for ATMEGA32 Microcontroller - Dio Driver.
 ...
 */
#define DIO_CFG_SW_MAJOR_VERSION              1
#define DIO_CFG_SW_MINOR_VERSION              0
#define DIO_CFG_SW_PATCH_VERSION              0

/*
 * AUTOSAR Version 4.0.3
 */
#define DIO_CFG_AR_RELEASE_MAJOR_VERSION     4
#define DIO_CFG_AR_RELEASE_MINOR_VERSION     4
#define DIO_CFG_AR_RELEASE_PATCH_VERSION     0
