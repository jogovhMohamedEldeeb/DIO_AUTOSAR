 ...
 * @details 	Dio driver header file,containing the AUTOSAR API specification and other variables and function that are exported by the Dio driver.
...
#define DIO_AR_RELEASE_PATCH_VERSION      3
